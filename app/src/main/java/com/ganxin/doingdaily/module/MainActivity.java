...
import com.ganxin.doingdaily.module.video.VideoListFragment;
...
public class MainActivity extends BaseActivity<MainContract.View, MainContract.Presenter> implements MainContract.View, TabLayout.OnTabClickListener {
    ...
    protected void initView() {
        ...
        tabs.add(new TabLayout.Tab(R.drawable.ic_bottomtabbar_video, R.string.tab_video, VideoListFragment.class));
